...
initialize_csv = r'initializeSB.csv'
...
class Genac(HPMSimWithInitializer):
    def get_res(self, m2d_path: str, ) -> dict:
        ...
        out_power_TD_titile: str = r' FIELD_POWER S.DA @COUPLER.PORT,FFT-#5.1'
        TD_title = out_power_TD_titile
        output_power_TD = grd.obs[TD_title]['data']
        dT_for_period_avg = 3 * 1 / (2 * self.desired_frequency * 1e9)
...
def get_genac(get_initializer: typing.Callable[[], typing.Union[Initializer, None]] = get_initializer):
    return Genac(get_initializer(), r'GenacX50kV_sweepB.m2d',
                 r'E:\BigFiles\GENAC\GENACX50kV\手动\GenacX50kV_tmplt_20240210_051249_02\sweepB',
                 desired_frequency=9.3,
                 desired_mean_power=6e6 * 0.6 /1e9,
                 lock=lock)
...
if __name__ == '__main__':
    # Initializer.make_new_initial_csv_from_template(initialize_csv,
    #                                                r'GenacX50kV_tmplt.m2d'
    #                                                )
